...
Запустите систему и проверьте, что все работает. Запрос автоматически попадет к специалистам. Если они подтвердят правильность настроек — вы получите доступ к полноценному запуску.
